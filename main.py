...
def main():
    ...
    print(f"entering phase with arg {args.mode}")
    # eax1it model
    if args.mode == 'train':
        print("entered train")
        wf_open = open(
        ...
        print(f"Entering for loop with {args.epoch + 1} epochs")
        ...
        print("evaluate and print independent-test-set performance")
        ...
        print("evaluate and print test-set performance")
