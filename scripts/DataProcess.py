...
class TEPDataset(Dataset):
    ...
    def seq_transform(self, sequence, max_len):
        # Convert sequence to uppercase to avoid case mismatches
        ...
        try:
            ...
            data_list = [AA_List.index(PAD) if aa not in AA_List else AA_List.index(aa) for aa in sequence]  # Replace invalid AAs with padding
